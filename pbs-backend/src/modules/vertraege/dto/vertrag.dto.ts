...
export class CreateVertragDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsNumber() @Min(1) laufzeit_monate?: number;
  @ApiProperty() @IsNumber() @Min(0) monatliche_rate!: number;
  @ApiPropertyOptional() @IsOptional() @IsString() leistungsumfang?: string;
  @ApiPropertyOptional() @IsOptional() @IsNumber() @Min(1) kuendigungsfrist?: number;
}
...
export class UpdateVertragDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsNumber() @Min(1) laufzeit_monate?: number;
  @ApiPropertyOptional() @IsOptional() @IsNumber() @Min(0) monatliche_rate?: number;
  @ApiPropertyOptional() @IsOptional() @IsString() leistungsumfang?: string;
  @ApiPropertyOptional() @IsOptional() @IsNumber() @Min(1) kuendigungsfrist?: number;
  @ApiPropertyOptional() @IsOptional() @IsIn(['aktiv', 'gekuendigt', 'abgelaufen', 'pausiert']) status?: string;
