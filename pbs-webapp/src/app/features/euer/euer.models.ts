...
export const EUER_AUSGABEN_ZEILEN: { zeile: string; label: string; keys: string[]; abzugFaktor?: number }[] = [
  ...
  { zeile: '52', label: 'Bürobedarf, Porto', keys: ['büromaterial', 'bürobedarf', 'porto', 'büro'] },
  { zeile: '54', label: 'Kfz-Kosten', keys: ['kfz', 'pkw', 'fahrzeug', 'auto'] },
  { zeile: '56', label: 'Reisekosten', keys: ['reise', 'fahrt'] },
  { zeile: '58', label: 'Bewirtungskosten (70 % abzugsfähig)', keys: ['bewirtung'], abzugFaktor: 0.7 },
