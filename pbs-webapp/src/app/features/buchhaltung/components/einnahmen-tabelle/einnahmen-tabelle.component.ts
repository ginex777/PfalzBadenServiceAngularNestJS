...
import { waehrungFormatieren, nettoBerechnen, steuerBerechnen } from '../../../../core/utils/format.utils';
...
export class EinnahmenTabelleComponent {
  ...
  protected feldAktualisieren(tempId: string, feld: keyof BuchhaltungZeile, wert: string | number): void {
